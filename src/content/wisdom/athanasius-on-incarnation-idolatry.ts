...
export const annunciationWisdom: WisdomQuote = {
  ...
  sourceAttribution: 'Public domain — NPNF Second Series, via ccel.org/ccel/athanasius/incarnation.iv.html',
};
